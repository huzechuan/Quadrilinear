...
corpus = ['icbu-new', 'ae-en-query-revise']  # language
word_embeddings = ['conll_english', 'conll_german', 'conll_dutch', 'conll_spanish', 'zh'] #'conll_spanish'  # language
char_embedding = False
# bert_embeddings = ['bert-base-multilingual-cased']
bert_embeddings = ['/home/yongjiang.jy/workspace/transformers-master/examples/token-classification/icbu-en-ner-v2.1-XMLR-base-large-model',
                   '/home/yongjiang.jy/workspace/transformers-master/examples/token-classification/ae-en-query-revise-BERT-large-large-model']
# Change if different task
eval_method = 'f1' # acc f1
tag_type = 'office' # ner upos
...
def run_command(gpu, model_path,
    ...
    sh_params = f'{tag_type}_crf_{corpu}_{emb}_L2={L2}_{learning_rate}'
