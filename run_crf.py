...
Embeddings Options: 
    ...
    Word for pos: glove ru fr de it es id hr 
    Word for NER: conll_dutch conll_english conll_german conll_spanish
"""
# Change if different model or embeddings
corpus = 'conll_03_german'  # language
word_embedding = 'conll_german'  #
...
model_path = tag_type + '/crf/' + corpus
use_crf = True
use_rnn = True
num_epochs = 150
batch_size = 32
